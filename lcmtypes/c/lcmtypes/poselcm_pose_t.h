...
#ifndef _poselcm_pose_t_h
#define _poselcm_pose_t_h

#ifdef __cplusplus
extern "C" {
#endif

typedef struct _poselcm_pose_t poselcm_pose_t;
struct _poselcm_pose_t
{
    uint8_t    robotid;
    int16_t    position[3];
...
/**
 * Create a deep copy of a poselcm_pose_t.
 * When no longer needed, destroy it with poselcm_pose_t_destroy()
 */
poselcm_pose_t* poselcm_pose_t_copy(const poselcm_pose_t* to_copy);

/**
 * Destroy an instance of poselcm_pose_t created by poselcm_pose_t_copy()
 */
void poselcm_pose_t_destroy(poselcm_pose_t* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _poselcm_pose_t_subscription_t poselcm_pose_t_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * poselcm_pose_t is received.
 */
typedef void(*poselcm_pose_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const poselcm_pose_t *msg, void *userdata);

/**
 * Publish a message of type poselcm_pose_t using LCM.
 *
 ...
 */
int poselcm_pose_t_publish(lcm_t *lcm, const char *channel, const poselcm_pose_t *msg);

/**
 * Subscribe to messages of type poselcm_pose_t using LCM.
 *
 ...
 */
poselcm_pose_t_subscription_t* poselcm_pose_t_subscribe(lcm_t *lcm, const char *channel, poselcm_pose_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by poselcm_pose_t_subscribe()
 */
...
/**
 * Encode a message of type poselcm_pose_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to poselcm_pose_t_encoded_size().
...
/**
 * Decode a message of type poselcm_pose_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with poselcm_pose_t_decode_cleanup().
 *
 ...
 */
int poselcm_pose_t_decode(const void *buf, int offset, int maxlen, poselcm_pose_t *msg);

/**
 * Release resources allocated by poselcm_pose_t_decode()
 * @return 0
 */
int poselcm_pose_t_decode_cleanup(poselcm_pose_t *p);

/**
 * Check how many bytes are required to encode a message of type poselcm_pose_t
 */
